            ...
            <ul class="list-unstyled topnav-menu float-right mb-0">
                            ...
                            <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                                ...
                                <div class="notification-list">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="media">
                                            <img class="d-flex mr-2 rounded-circle"
                                                src="{{ url('/') }}/assets/images/users/user-2.jpg"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="media">
                                            <img class="d-flex mr-2 rounded-circle"
                                                src="{{ url('/') }}/assets/images/users/user-5.jpg"
                                                alt="Generic placeholder image" height="32">
                                            <div class="media-body">
                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img src="{{ url('/') }}/assets/images/users/user-1.jpg"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="{{ url('/') }}/assets/images/users/user-4.jpg"
                                        class="img-fluid rounded-circle" alt="" />
                                </div>
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                        href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ url('/') }}/assets/images/users/user-1.jpg" alt="user-image"
